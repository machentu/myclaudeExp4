"""
Config for supresDeconv model quantization test.
Matches examples_use/config-deconv.py configuration.
...
config.path_intermediate_pbmodel = abs_path('quantinv_outputs/supresDeconv/deconv.pb')
