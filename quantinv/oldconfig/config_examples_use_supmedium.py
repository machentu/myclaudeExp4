...
config.path_intermediate_pbmodel = abs_path('quantinv_outputs/supmedium/fixed_example_pb_before_transed_for_step2.pb')
...
config.path_pbmodel = abs_path('examples_use/supmedium/256/supmedium256.pb')
