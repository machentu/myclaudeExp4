"""
Config for supsharp model (640x360) quantization test.
Matches examples_use/config-640.py configuration.
...
# Output paths
config.path_fixed_pbmodel = abs_path('quantinv_outputs/supsharp/fixed_example_pb_after_transed_for_step3.pb')
config.path_intermediate_pbmodel = abs_path('quantinv_outputs/supsharp/sharp.pb')
config.path_float_minmaxtxt = abs_path('quantinv_outputs/supsharp/floatminmax_txt')
