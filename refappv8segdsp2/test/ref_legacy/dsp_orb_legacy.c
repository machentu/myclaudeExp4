/* dsp_orb_legacy.c — FROZEN copy of refappv8segdsp/src/dsp_orb.c (entry renamed
 * to dsp_orb_extract_legacy). It calls the unmodified *_core kernels exactly
 * as refappv8segdsp does, so test_bitexact_ab can compare the optimized
 * refappv8segdsp2 pipeline against the original byte-for-byte. Do NOT edit
 * this file except to re-freeze it from a new refappv8segdsp baseline.
 *
